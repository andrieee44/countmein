...
| ---- | ------- | ------- | ---- |
| create_calendar |  | p_actor_user_id bigint; p_name varchar; p_color varchar; p_ical longblob; p_description text; p_AES_SECRET_KEY binary; out_calendar_id bigint | PROCEDURE |
